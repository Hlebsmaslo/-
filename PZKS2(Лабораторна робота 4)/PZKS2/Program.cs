    ...
    class Program
    {
        static void Main()
        {
            ...
            while (true)
            {
                ...
                string optimizedExpression = ExpressionToInfix.Convert(astRoot);
                Console.WriteLine($"Вираз після застосування асоціативного закону та оптимізацій: {optimizedExpression}");
